...
export const modeDescriptions = {
	...
	Ghosts: "A quarter of the participants are chosen as ghosts. Ghosts are invisible but have a shadow that appears every few seconds. Kill the ghosts to win!",
};
