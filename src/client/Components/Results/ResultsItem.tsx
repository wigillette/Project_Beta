...
class ResultsItem extends Roact.Component<UIProps> {
	...
	render() {
		return (
			<frame {...RectContainer} Size={new UDim2(0.5, 0, 1, 0)} ZIndex={17}>
				...
				<imagelabel {...RectShadow} ImageColor3={googleMaterial.cardShadow} ZIndex={18}></imagelabel>
			</frame>
		);
	}
}
